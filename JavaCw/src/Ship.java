                ...
                try {
                    ...
                    if (cabinNum < 12 && cabinNum >= 0) {
                        if (isEmpty(cabinNum) != -1) {
                            //Name for cabin
                            cabinName = "seafare"; //store name for cabin
                            ...
                            while (true) {
                                if (expenses.length() != 16) {
                                    System.out.println("Expenses : <<<<<< User of  creditcard for the payment >>>>>>\n");
                                    System.out.println("Expenses : - Use credit card for payment-");
    ...
    public void delete(int cabinNum) {
        ...
        if (isEmpty(cabinNum) == -1) {
            ...
            if (ans == 'Y') {
                ...
                getCabins()[cabinNum].setCabinName("");
        ...
        try {
            ...
            for (int i = 0; i < getCabins().length; i++) {
                if (isEmpty(i) != -1) {
                    ...
                    writerObject.write("- Sur Name : " + getCabins()[i].getPayingPassenger().getSurName() + "\n");
